...
{
	public class DynamicSpriteFontOrig : IDisposable
	{
        ...
        {
			_fontSystem.SetRatio(idx, ratio);
        }
		...
		DynamicSpriteFontOrig(byte[] ttf, int defaultSize, int textureWidth, int textureHeight, int blur, int stroke)
		{
		...
		public static DynamicSpriteFontOrig FromTtf(byte[] ttf, int defaultSize, int textureWidth = 1024, int textureHeight = 1024, int blur = 0, int stroke = 0)
		{
			return new DynamicSpriteFontOrig(ttf, defaultSize, textureWidth, textureHeight, blur, stroke);
		}

		public static DynamicSpriteFontOrig FromTtf(Stream ttfStream, int defaultSize, int textureWidth = 1024, int textureHeight = 1024, int blur = 0, int stroke = 0)
		{
