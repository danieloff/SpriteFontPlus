...
namespace SpriteFontPlus
{
	public static class SpriteBatchExtensions
	{
		...
		{
			return font.DrawString(batch, text, pos, color, bottomleft: true);
		}
		...
		{
			return font.DrawString(batch, text, pos, color, scale, bottomleft: true);
		}
		...
		*/
		...
		public static double DrawString(this SpriteBatch batch, DynamicSpriteFont font, StringBuilder text, Vector2 pos, Color color)
		{
			return font.DrawString(batch, text, pos, color);
		}

		public static double DrawString(this SpriteBatch batch, DynamicSpriteFont font, StringBuilder text, Vector2 pos, Color color, Vector2 scale)
		{
			return font.DrawString(batch, text, pos, color, scale);
		}

		public static double DrawString(this SpriteBatch batch, DynamicSpriteFont font, StringBuilder text, Vector2 pos, Color[] glyphColors)
		{
			return font.DrawString(batch, text, pos, glyphColors);
		}

		public static double DrawString(this SpriteBatch batch, DynamicSpriteFont font, StringBuilder text, Vector2 pos, Color[] glyphColors, Vector2 scale)
		{
			return font.DrawString(batch, text, pos, glyphColors, scale);
		}
		*/
